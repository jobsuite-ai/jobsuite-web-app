...
export async function DELETE(
    ...
    try {
        ...
        // Delete specific resource via backend API
        const deleteResponse = await fetch(
            `${apiBaseUrl}/api/v1/contractors/${contractorId}/estimates/${estimate_id}/resources/${resource_id}`,
            {
                method: 'DELETE',
                headers: {
        ...
        if (!deleteResponse.ok) {
            ...
            return NextResponse.json(
                { message: errorData.detail || 'Failed to delete resource' },
